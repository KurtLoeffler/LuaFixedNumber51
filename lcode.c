...
static int constfolding (OpCode op, expdesc *e1, expdesc *e2) {
  ...
  switch (op) {
    ...
    case OP_DIV:
      if (v2 == LUA_NUMBER_CAST 0) return 0;  /* do not attempt to divide by 0 */
    ...
    default: lua_assert(0); r = LUA_NUMBER_CAST 0; break;
  }
...
void luaK_prefix (FuncState *fs, UnOpr op, expdesc *e) {
  expdesc e2;
  e2.t = e2.f = NO_JUMP; e2.k = VKNUM; e2.u.nval = LUA_NUMBER_CAST 0;
  switch (op) {
    case OPR_MINUS: {
      if (e->k == VK)
